        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-6 mb-12 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-3 text-base md:text-lg">
              ...
              <li><a href="#projects" className="hover:text-ps-accent transition">Projects</a></li>
              <li><a href="#alumni" className="hover:text-ps-accent transition">Alumni</a></li>
              <li><a href="#updates" className="hover:text-ps-accent transition">Updates</a></li>
            </ul>
          </div>
